...
class FormatConverter:
    ...
    def convert(self, 
        ...
        if source_format == 'urdf' and target_format == 'mjcf':
            ...
            raise NotImplementedError(f"Conversion {source_format} -> {target_format} not implemented yet")
        
        logger.info(f"Converted {source_path} ({source_format}) to {output_path} ({target_format})")
        return output_path
